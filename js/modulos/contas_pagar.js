  ...
  conteudo.innerHTML=
    ...
    '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;flex-wrap:wrap;gap:10px">'+
      ...
      '<div style="display:flex;gap:8px;flex-wrap:wrap">'+
        '<button onclick="abrirGerenciarBancos(\''+empresaId+'\')" style="padding:7px 14px;border-radius:6px;border:1px solid #2a4a6a;background:transparent;color:#60a5fa;cursor:pointer;font-size:0.82rem">🏦 Bancos</button>'+
        '<button onclick="abrirGerenciarPlano(\''+empresaId+'\')" style="padding:7px 14px;border-radius:6px;border:1px solid #2a4a6a;background:transparent;color:#60a5fa;cursor:pointer;font-size:0.82rem">📊 Plano Contas</button>'+
        '<button onclick="abrirFormConta(\'\',\''+empresaId+'\')" class="btn-salvar" style="padding:7px 18px">+ Lançar</button>'+
      '</div>'+
    '</div>'+
